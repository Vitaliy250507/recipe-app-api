...
class PublicUserApiTest(TestCase):
    ...
    def test_create_user_successfully(self):
        payload = {"email": "test@hmail.com", "password": "pass123", "name": "testuser"}
    ...
    def test_user_passowrd_short(self):
        payload = {"email": "test@hmail.com", "password": "pass", "name": "testuser"}
        res = self.client.post(CREATE_USER_URL, payload)
...
class PrivateUserApiTEst(TestCase):
    def setUp(self):
        self.user = create_user(
            email="test@example.com", password="testpass123", name="username"
        )
        self.client = APIClient()
